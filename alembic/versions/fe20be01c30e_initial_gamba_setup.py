...
Revision ID: fe20be01c30e
Revises: 
Create Date: 2026-04-23 03:03:38.530661
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('rarity', sa.Enum('THRASH', 'MEH', 'GOOD', 'HOLY', name='itemrarity'), nullable=False),
